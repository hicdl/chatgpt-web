# chatgpt-web
Pure Javascript ChatGPT page based on OpenAI API 
...
- **仅部署HTML**
    ...
    - 不可正常访问`api.openai.com`，填写其反代地址（可使用[Cloudflare Worker](https://github.com/hicdl/openai-proxy)等反代），注意：反代接口响应需添加跨域Header `Access-Control-Allow-Origin`
- **同时部署HTML和OpenAI反代接口**
...
## PWA应用
部署文件[icon.png](https://raw.githubusercontent.com/hicdl/chatgpt-web/main/icon.png)，[manifest.json](https://raw.githubusercontent.com/hicdl/chatgpt-web/main/manifest.json)，[sw.js](https://raw.githubusercontent.com/hicdl/chatgpt-web/main/sw.js)到index.html同目录下，即可支持PWA应用。
